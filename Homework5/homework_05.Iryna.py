...
list_from_car_data = list(car_data)

result = []

for key in list_from_car_data:
    color, y, eng, car_type, p = car_data[key]
    if y >= year and eng >= engine_volume and p <= price:
        result.append((key, color, y, eng, car_type, p))
